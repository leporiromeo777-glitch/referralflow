...
- **Tutto il corpo in un solo paragrafo** (richiesta del medico, 14.9.2026): niente righe vuote fra il saluto d'apertura e quello finale. Le etichette restano nel flusso del paragrafo, non più in riga propria. Blocchi con etichetta: FRCV, Comorbidità, Allergie e intolleranze, Elettrocardiogramma (formula fissa «ritmo sinusale regolare normocardico con PR nella norma e QRS fine. Assenza di alterazioni specifiche della ripolarizzazione»), Ecocardiogramma (blocco standard copiato dal referto strumentale), Holter (data), cicloergometria («per un carico di N watt … doppio prodotto … pressione al picco … frequenza massima»).
...
- Chiusura «Cordiali saluti,» e firma «Marco» + «(partito dopo dettatura)»; poi eventuali «Copia: … , in sede» e «Allegato: -…». **Corretto il 14.9.2026 dal medico**: nelle 12 lettere del campione la chiusura era «Cordiali e collegiali saluti.» (10 su 12) con la firma per esteso, ma non è la forma che vuole; una regola di stile del suo dizionario riscriveva «Cordiali saluti» in «Cordiali e collegiali saluti» ed è stata tolta.

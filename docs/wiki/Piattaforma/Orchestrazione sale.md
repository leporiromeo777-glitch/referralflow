...
Sotto il tasto, **quel che serve al medico col paziente davanti**, e solo roba che la piattaforma sa già: Cartella · Chiedi a Cleo · Detta il referto · Documenti, un avviso rosso per le **allergie**, e poi i riquadri — terapia in corso (dal blocco Terapia dell'ultimo referto confermato, con la data), perché è qui (indicazione e problemi aperti), ultimi referti, esami in cartella, referral aperte, altri fatti dal grafo. **Ogni riquadro compare solo se ha qualcosa dentro**: una pagina piena di sezioni vuote è peggio di una pagina corta. In coda, ultima visita, prossima e medico curante. Per un paziente che è solo in agenda e non in cartella, la pagina lo dice invece di mostrare riquadri vuoti.

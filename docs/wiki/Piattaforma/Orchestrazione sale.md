...
**E. La pagina «Visita» è stata tolta** (16.9.2026 sera). Era nata come centro di controllo di una singola visita — l'elenco dei propri pazienti, il nome grande, «Inizia visita», il cronometro, la cartella e i servizi attorno — ed è durata poche ore: allo studio non è piaciuta, e una pagina che nessuno vuole aprire non misura niente. Tolta dal menu e dal codice del prototipo (v132).

Resta però la domanda che l'aveva fatta nascere: **«come sappiamo quando il medico comincia davvero»**. La risposta è ancora un tocco di una persona — da MediOnline l'inizio non arriva mai (§9) — e oggi quel tocco sta solo nella **pagina Stanza** (`#/stanza`, fuori dal menu, fatta per lo schermo di una stanza): *in preparazione · pronto · il medico è entrato · finito · uscito*. Finché l'inizio si registra solo di lì, la durata misurata arriva solo dalle stanze che hanno quello schermo: è un buco noto, non una svista.

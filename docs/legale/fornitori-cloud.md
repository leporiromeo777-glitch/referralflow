...
| Classi di dati ammesse | solo testo pseudonimizzato; mai audio, mai identificativi, mai documento intero quando bastano gli span. Dal 15.9.2026 anche la classe **«domanda medica generale»**: testo che NON contiene dati personali (una domanda di medicina riscritta e approvata da una persona), usata dalla funzione «Domanda medica» della piattaforma con `google/gemma-4-31B-it`. Dal 16.9.2026 anche la classe **«contesto clinico pseudonimizzato»**: due paragrafi ricavati dalla cartella dal modello locale — situazione clinica e domanda generale — senza nome, data di nascita, AVS, indirizzo, recapiti, numeri di pratica, nomi di medici o di strutture, e senza età esatta, usata dalla funzione «Ricerca clinica esterna protetta». Questa classe NON è anonima: è un dato sanitario pseudonimizzato che riguarda una persona, come il testo dei referti che la catena manda già allo stesso fornitore, e ricade sotto le stesse condizioni (DPA da ottenere, conservazione e uso per addestramento da confermare). Prima di uscire passa da un controllo automatico che cerca nel testo gli identificatori veri di quel paziente e blocca l'invio se ne trova uno |

...
for f in pipeline.py profilo-cardiologia.json allinea-tempi.py trascrivi-voxtral.py pannello.py \
         ...
         compila-conoscenza.py conoscenza-agenti.json banco-arbitro.py banco-omissioni.py banco-terapia.py banco-coerenza.py banco-vad.py banco-whisper-flag.py; do

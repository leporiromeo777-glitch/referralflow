...
CASI = [
    ...
    ("esca: stessa frase con parole storpiate e regia dettata",
     "non dà ultimo affronte di un antipro bnt minimamente elevato tra parentesi compatibile con l'età della paziente chiusa parentesi",
     "Non da ultimo a fronte di un NT-proBNP minimamente elevato (compatibile con l'età della paziente).",
     [], []),

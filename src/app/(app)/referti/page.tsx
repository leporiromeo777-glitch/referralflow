  ...
  return (
    <>
      ...
      <p className="muted small" style={{ marginTop: 8 }}>
        <Link href="/referti/qualita">Qualità della dettatura</Link> · <Link href="/referti/confronto">Confronto cieco</Link> · <a href="/dittafono/index.html">Detta dal telefono</a> · <a href="/prototipo/index.html?v=20#/reports">Prototipo con i dati veri</a>
